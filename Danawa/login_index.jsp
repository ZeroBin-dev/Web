...
<div class="fixed_bar">
<a href="login_index.jsp"><h3 class="glyphicon glyphicon-home"></h3></a>
<a href="bag.html"><h3 class="glyphicon glyphicon-shopping-cart"></h3></a>
<a href="mypage.jsp"><h3 class="glyphicon glyphicon-user"></h3></a>
...
<div class="top_menu">
		...
		<span class="col-md-1" ><a href="login_index.jsp.jsp" class="glyphicon glyphicon-home"></a></span>
...
<div class="container">
	...
	<header>	
			<a class="btnlogo" href="login_index.jsp.jsp">
